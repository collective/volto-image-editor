...
# Volto Image Editor build configuration file
...
ogp_site_name = "Volto Image Editor Documentation"
ogp_type = "website"
...
htmlhelp_basename = "Volto Image EditorDocumentation"
...
latex_documents = [
    (
        "index",
        "Volto Image EditorDocumentation.tex",
        "Volto Image Editor Documentation",
        "simplesconsultoria community",
        "manual",
    ),
]
